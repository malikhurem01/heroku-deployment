...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public SecurityConfig(UserServiceImpl userServiceImpl, PasswordConfig passwordConfig, JWTConfig jwtConfig) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(new JWTAuthorizationFilter(jwtConfig), UsernamePasswordAuthenticationFilter.class);
    }
